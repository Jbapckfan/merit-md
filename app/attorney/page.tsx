...
function FindingCard({
  ...
  return (
    <AnimatedSection delay={index * 0.1}>
      <div
        className="rounded-2xl bg-[#15111e]/80 backdrop-blur-xl border border-[#2a2440] shadow-lg shadow-black/20
                   hover:border-[#3d3660] transition-colors duration-300 overflow-hidden"
      >
        <button
          type="button"
        ...
        >
          ...
          <div className="flex-1">
            <h3 className="text-[#e5e2ff] font-semibold text-lg mb-1">{title}</h3>
            <p className="text-[#9490b0] text-sm leading-relaxed">{front}</p>
          </div>
          <motion.svg
            className="w-5 h-5 text-[#4f8ff7] mt-1 shrink-0"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
        ...
        <AnimatePresence initial={false}>
          {expanded && (
            ...
            >
              <div className="px-6 pb-6 pl-20 text-[#e5e2ff] text-sm leading-relaxed border-t border-[#2a2440] pt-4">
                {back}
              </div>
            </motion.div>
          )}
    ...
    <>
      ...
      <main className="overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto text-center">
                  ...
                  <motion.span
                    ...
                    className={
                      word === "Minutes." || word === "Depth."
                        ? "bg-gradient-to-r from-[#4f8ff7] to-[#6ba1ff] bg-clip-text text-transparent"
                        : ""
                    }
                  >
                    {word}
              ...
              >
                ...
                <div className="bg-[#15111e]/60 backdrop-blur-xl border border-[#4f8ff7]/30 rounded-xl p-5 text-left">
                  <div className="text-[#4f8ff7] text-xs font-bold uppercase tracking-wider mb-2">Deep Dive Analysis</div>
                  <p className="text-[#9490b0] text-sm leading-relaxed">
              ...
              {/* Free tier note */}
              <motion.p
                className="text-[#9490b0] text-sm mt-4 text-center"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
          ...
          <div className="max-w-7xl mx-auto px-6 relative">
            <AnimatedSection className="text-center mb-16">
              ...
              <p className="text-[#9490b0] text-lg max-w-xl mx-auto">
                ...
                medical knowledge. Tap a finding to learn more.
              </p>
            </AnimatedSection>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
              {findings.map((f, i) => (
                <FindingCard key={f.title} {...f} index={i} />
              ))}
            </div>
          </div>
        </section>
        ...
        <section id="deep-dive" className="py-20 md:py-28 border-t border-[#2a2440]/50">
          <div className="max-w-7xl mx-auto px-6">
            <AnimatedSection className="text-center mb-16">
              <span className="text-[#4f8ff7] text-sm font-medium tracking-wider uppercase bg-[#4f8ff7]/10 border border-[#4f8ff7]/20 px-4 py-1.5 rounded-full backdrop-blur-sm inline-block mb-6">
                Deep Dive Analysis
              </span>
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
        ...
        <section className="py-12 border-t border-[#2a2440]/50">
          <div className="max-w-4xl mx-auto px-6">
            <AnimatedSection>
              <div className="bg-gradient-to-r from-[#4f8ff7]/5 to-[#4f8ff7]/5 border border-[#4f8ff7]/20 rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between gap-6">
                <div>
        ...
        <section className="py-24 md:py-32 border-t border-[#2a2440]/50 relative overflow-hidden">
          {/* Gradient background */}
          <div className="absolute inset-0 bg-gradient-to-r from-[#4f8ff7]/10 via-[#4f8ff7]/10 to-[#4f8ff7]/10" />
          ...
          <div className="relative max-w-3xl mx-auto px-6 text-center">
            <AnimatedSection>
              <h2 className="text-3xl md:text-5xl font-bold mb-4">
                Stop Guessing.{" "}
                <span className="bg-gradient-to-r from-[#4f8ff7] to-[#6ba1ff] bg-clip-text text-transparent">
                  Start Knowing.
                </span>
              </h2>
