...
export default function CaseReportPage() {
  ...
  useEffect(() => {
    ...
    const isShare = caseId.length === 36 && !caseId.includes("-") ? false : true;
  ...
  return (
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-8">
        ...
        {/* Case Summary */}
        <section className="bg-merit-card border border-merit-border rounded-2xl p-6 mb-6">
            ...
            <div className="mt-4 pt-4 border-t border-merit-border">
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {uploads.map((u, i) => (
                  <span
                    key={i}
                    className="bg-merit-bg border border-merit-border rounded-lg px-3 py-1 text-xs text-merit-text-muted"
                  >
                    {u.filename}
                  </span>
                ))}
        ...
        {report && (
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <section className="bg-merit-card border border-merit-border rounded-2xl p-6">
            ...
            {/* Recommendations */}
            <section className="bg-merit-card border border-merit-border rounded-2xl p-6 mb-8">
            ...
            <div className="flex items-center gap-4 pb-12">
              <button
                onClick={handleShare}
                className="bg-merit-card border border-merit-border hover:border-merit-border-hover text-merit-text px-6 py-2.5 rounded-xl text-sm font-medium transition flex items-center gap-2"
              >
