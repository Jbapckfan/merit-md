      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/dashboard/new"
              className="bg-merit-accent hover:bg-merit-accent-hover text-white px-5 py-2.5 rounded-xl text-sm font-semibold transition"
            >
              New Case Analysis
            </Link>
            <button
        ...
        {loading ? (
          ...
          <div className="bg-merit-card border border-merit-border rounded-2xl p-12 text-center">
            ...
            <Link
              href="/dashboard/new"
              className="inline-block bg-merit-accent hover:bg-merit-accent-hover text-white px-6 py-2.5 rounded-xl text-sm font-semibold transition"
            >
              Submit Your First Case
            </Link>
          </div>
        ) : (
          <div className="bg-merit-card border border-merit-border rounded-2xl overflow-hidden">
              ...
              <tbody>
                {cases.map((c) => (
                  <tr
                    ...
                    className="border-b border-merit-border last:border-b-0 hover:bg-merit-card-hover cursor-pointer transition"
                  >
