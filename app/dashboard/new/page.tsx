...
export default function NewCasePage() {
  ...
  return (
    <>
      <Header isLoggedIn />
      <main className="max-w-3xl mx-auto px-6 py-8 bg-merit-bg min-h-[calc(100vh-4rem)]">
        <AnimatedSection>
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-merit-text">New Case Analysis</h1>
        ...
        <AnimatedSection delay={0.1}>
          <form
            ...
            className="bg-merit-card/50 backdrop-blur-xl border border-merit-border rounded-2xl p-8 space-y-6 shadow-xl shadow-black/20"
          >
            {error && (
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-merit-bg/80 border border-merit-border rounded-xl px-4 py-2.5 text-merit-text focus:border-merit-accent focus:ring-1 focus:ring-merit-accent/30 transition"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-merit-bg/80 border border-merit-border rounded-xl px-4 py-2.5 text-merit-text placeholder:text-merit-text-muted/50 focus:border-merit-accent focus:ring-1 focus:ring-merit-accent/30 transition resize-y"
            ...
            <div className="flex items-center gap-4 pt-2">
              <button
                type="submit"
                disabled={loading}
                className="bg-merit-accent hover:bg-merit-accent-hover disabled:opacity-50 disabled:cursor-not-allowed text-white px-8 py-2.5 rounded-xl font-semibold transition shadow-lg shadow-merit-accent/20 flex items-center gap-2"
              >
                {loading ? (
                  <>
